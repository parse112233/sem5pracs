...
def generate_digraphs(plaint_text):
...
def playfair_encrypt(plain_text, key):
    ...
    plain_text_lists = generate_digraphs(plain_text)
...
def playfair_decrypt(cipher_text, key):
    ...
    cipher_text_lists = generate_digraphs(cipher_texts)
